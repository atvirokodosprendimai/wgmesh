...
A netcup node (`159.195.25.129`) repeatedly attempts to NAT-punch to its own public IP, producing 40 HELLO timeouts:

```
time=2026-03-12T19:00:37.595Z level=INFO msg="[NAT] Punch timeout with 159.195.25.129:52790 after 40 HELLO attempts"
```
...
- Log evidence: `[NAT] Punch timeout with 159.195.25.129:52790 after 40 HELLO attempts` (2026-03-12)
