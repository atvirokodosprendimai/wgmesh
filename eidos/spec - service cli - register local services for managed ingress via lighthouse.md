...
> [[main.go]] — new `service` subcommand dispatch
> [[pkg/lighthouse/client.go]] — new Lighthouse API client (does not exist yet)
> [[pkg/mesh/services.go]] — local service state management (does not exist yet)
