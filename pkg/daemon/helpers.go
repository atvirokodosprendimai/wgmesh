...
type localNodeState struct {
	...
	MeshIPSeed   string `json:"mesh_ip_seed,omitempty"` // original pubkey used for IP derivation — preserved across key rotation
}
